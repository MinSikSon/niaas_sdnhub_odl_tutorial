 ...
 *
 */
public interface SMS_ActionRegLoadNodesNodeTableFlowApplyActionsCase
    extends
    DataObject,
    Augmentable<SMS_ActionRegLoadNodesNodeTableFlowApplyActionsCase>,
    SMS_ActionRegLoadGrouping,
    Action
{



    public static final QName QNAME = org.opendaylight.yangtools.yang.common.QName.cachedReference(org.opendaylight.yangtools.yang.common.QName.create("urn:opendaylight:openflowplugin:extension:nicira:action","2014-07-14","nx-action-reg-load-nodes-node-table-flow-apply-actions-case"));
