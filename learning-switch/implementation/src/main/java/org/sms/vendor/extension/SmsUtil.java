...
public final class SmsUtil {
	public static final ActionSerializerKey<?> createOfJavaKeyFrom(SmsActionSerializerKey key) {
		return new ActionSerializerKey<>(key.getVersion(), key.getSubtype(), SmsConstants.SMS_VENDOR_ID);
	}
}
