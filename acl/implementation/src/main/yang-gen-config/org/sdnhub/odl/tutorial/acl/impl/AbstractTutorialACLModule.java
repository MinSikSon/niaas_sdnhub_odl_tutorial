...
* Generated at: Tue Jun 21 13:58:37 KST 2016
*
...
public abstract class AbstractTutorialACLModule extends org.opendaylight.controller.config.spi.AbstractModule<AbstractTutorialACLModule> implements org.sdnhub.odl.tutorial.acl.impl.TutorialACLModuleMXBean {
    private static final org.slf4j.Logger LOGGER = org.slf4j.LoggerFactory.getLogger(org.sdnhub.odl.tutorial.acl.impl.AbstractTutorialACLModule.class);
    ...
    public AbstractTutorialACLModule(org.opendaylight.controller.config.api.ModuleIdentifier identifier,org.opendaylight.controller.config.api.DependencyResolver dependencyResolver) {
        super(identifier, dependencyResolver);
    }

    public AbstractTutorialACLModule(org.opendaylight.controller.config.api.ModuleIdentifier identifier,org.opendaylight.controller.config.api.DependencyResolver dependencyResolver,AbstractTutorialACLModule oldModule,java.lang.AutoCloseable oldInstance) {
    ...
    public boolean canReuseInstance(AbstractTutorialACLModule oldModule){
    ...
    public boolean isSame(AbstractTutorialACLModule other) {
        if (other == null) {
    ...
    public boolean equals(Object o) {
        ...
        AbstractTutorialACLModule that = (AbstractTutorialACLModule) o;
